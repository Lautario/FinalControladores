...
void setup() {
  Out = createWriter("BasicTest/BasicTest.ino");
  ...
  Out.println("");  
  Out.println("Serial.print(\"RAM[\");");
  Out.println("Serial.print(300);");
  Out.println("Serial.print(\"] = \");");
  Out.println("Serial.println(M[300]);"); 

  Out.println("");  
  Out.println("Serial.print(\"RAM[\");");
  Out.println("Serial.print(401);");
  Out.println("Serial.print(\"] = \");");
  Out.println("Serial.println(M[401]);"); 

  Out.println("");  
  Out.println("Serial.print(\"RAM[\");");
  Out.println("Serial.print(402);");
  Out.println("Serial.print(\"] = \");");
  Out.println("Serial.println(M[402]);"); 

  Out.println("");  
  Out.println("Serial.print(\"RAM[\");");
  Out.println("Serial.print(3006);");
  Out.println("Serial.print(\"] = \");");
  Out.println("Serial.println(M[3006]);"); 

  Out.println("");  
  Out.println("Serial.print(\"RAM[\");");
  Out.println("Serial.print(3012);");
  Out.println("Serial.print(\"] = \");");
  Out.println("Serial.println(M[3012]);"); 

  Out.println("");  
  Out.println("Serial.print(\"RAM[\");");
  Out.println("Serial.print(3015);");
  Out.println("Serial.print(\"] = \");");
  Out.println("Serial.println(M[3015]);");

  Out.println("");  
  Out.println("Serial.print(\"RAM[\");");
  Out.println("Serial.print(11);");
  Out.println("Serial.print(\"] = \");");
  Out.println("Serial.println(M[11]);"); 
