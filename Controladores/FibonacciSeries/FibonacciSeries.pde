...
void setup() {
  Out = createWriter("FibonacciSeries/FibonacciSeries.ino");
 ...
 Out.println("");  
  ...
  Out.println("Serial.print(3000);");
  Out.println("Serial.print(\"] = \");");
  Out.println("Serial.println(M[3000]);"); 

  Out.println("");  
  Out.println("Serial.print(\"RAM[\");");
  Out.println("Serial.print(3001);");
  Out.println("Serial.print(\"] = \");");
  Out.println("Serial.println(M[3001]);"); 

  Out.println("");  
  Out.println("Serial.print(\"RAM[\");");
  Out.println("Serial.print(3002);");
  Out.println("Serial.print(\"] = \");");
  Out.println("Serial.println(M[3002]);"); 

  Out.println("");  
  Out.println("Serial.print(\"RAM[\");");
  Out.println("Serial.print(3003);");
  Out.println("Serial.print(\"] = \");");
  Out.println("Serial.println(M[3003]);");

  Out.println("");  
  Out.println("Serial.print(\"RAM[\");");
  Out.println("Serial.print(3004);");
  Out.println("Serial.print(\"] = \");");
  Out.println("Serial.println(M[3004]);"); 

  Out.println("");  
  Out.println("Serial.print(\"RAM[\");");
  Out.println("Serial.print(3005);");
  Out.println("Serial.print(\"] = \");");
  Out.println("Serial.println(M[3005]);");
