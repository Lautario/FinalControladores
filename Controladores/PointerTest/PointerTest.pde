...
void setup() {
  Out = createWriter("PointerTest/PointerTest.ino");
  ...
  Out.println("");  
  Out.println("Serial.print(\"RAM[\");");
  Out.println("Serial.print(3);");
  Out.println("Serial.print(\"] = \");");
  Out.println("Serial.println(M[3]);"); 

  Out.println("");  
  Out.println("Serial.print(\"RAM[\");");
  Out.println("Serial.print(4);");
  Out.println("Serial.print(\"] = \");");
  Out.println("Serial.println(M[4]);"); 

  Out.println("");  
  Out.println("Serial.print(\"RAM[\");");
  Out.println("Serial.print(3032);");
  Out.println("Serial.print(\"] = \");");
  Out.println("Serial.println(M[3032]);"); 

  Out.println("");  
  Out.println("Serial.print(\"RAM[\");");
  Out.println("Serial.print(3046);");
  Out.println("Serial.print(\"] = \");");
  Out.println("Serial.println(M[3046]);");   
